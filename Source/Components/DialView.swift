...
class DialView: UIView {
   ...
   @objc private func handleLongPress(_ gesture: UILongPressGestureRecognizer) {
       ...
       case .began:
           // No need to show the dial here since it's already visible
           break
       case .changed:
           updateSelectedAction(at: location)
       case .ended:
       ...
       // Animate dial out
       private func animateDialOut(completion: @escaping () -> Void) {
       ...
       private func commitHeartAction() {
           // Implement the logic to commit the heart action here
           // You may need to pass the necessary data (e.g., entry) to the DialView
           // or define a delegate method to handle the action in the FeedCell
       }
}
